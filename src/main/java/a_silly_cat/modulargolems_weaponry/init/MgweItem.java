...
public class MgweItem {
    ...
    static {
        ...
        CULL_PROFICIENCY = mgwe.ITEMS.register("cull_proficiency", () ->
                new CullProficiencyTrinketItem(new Item.Properties().stacksTo(1)));
        ...
        INFINITYEDGE = mgwe.ITEMS.register("infinity_edge", () ->
