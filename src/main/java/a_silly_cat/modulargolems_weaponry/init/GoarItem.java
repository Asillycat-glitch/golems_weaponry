...
public class GoarItem  {
    public static final RegistryObject<SimpleUpgradeItem> Kill_streak;
    static {
        Kill_streak = modulargolems_weaponry.ITEMS.register("kill_streak",
                () -> new SimpleUpgradeItem(new Item.Properties(),() -> GoarModifier.Kill_streak.get(),1,false));
    }
